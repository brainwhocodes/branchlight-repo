...
| `OMP_BROWSER_EXECUTABLE_PATH`  | Browser tool Chromium executable override                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Variable                               | Behavior                                                                                 |
| -------------------------------------- | ---------------------------------------------------------------------------------------- |
| `OMP_BROWSER_PROXY`                   | Adds Chromium's `--proxy-server` launch argument                                         |
| `OMP_BROWSER_PROXY_BYPASS_LOOPBACK`  | Boolean-like flag adds `<-loopback>` to the bypass list so localhost also uses the proxy |
| `OMP_BROWSER_PROXY_IGNORE_CERT_ERRORS` | Boolean-like flag launches Chromium with certificate errors ignored                       |
